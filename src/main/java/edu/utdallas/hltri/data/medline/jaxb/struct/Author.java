...
public class Author implements Serializable
{
    ...
    public boolean equals(java.lang.Object object) {
        ...
        {
            CollectiveName leftCollectiveName;
            leftCollectiveName = this.getCollectiveName();
            CollectiveName rightCollectiveName;
            rightCollectiveName = that.getCollectiveName();
            if (this.collectiveName!= null) {
                if (that.collectiveName!= null) {
                    if (!leftCollectiveName.equals(rightCollectiveName)) {
                        return false;
                    }
                } else {
                    return false;
        ...
        {
            String leftEqualContrib;
            leftEqualContrib = this.getEqualContrib();
            String rightEqualContrib;
            rightEqualContrib = that.getEqualContrib();
            if (this.equalContrib!= null) {
                if (that.equalContrib!= null) {
                    if (!leftEqualContrib.equals(rightEqualContrib)) {
                        return false;
                    }
                } else {
                    return false;
    ...
    public int hashCode() {
        int currentHashCode = 1;
        {
            ...
            CollectiveName theCollectiveName;
            theCollectiveName = this.getCollectiveName();
            if (this.collectiveName!= null) {
                currentHashCode += theCollectiveName.hashCode();
            }
        }
        {
            currentHashCode = (currentHashCode* 31);
        ...
        {
            currentHashCode = (currentHashCode* 31);
            String theEqualContrib;
            theEqualContrib = this.getEqualContrib();
            if (this.equalContrib!= null) {
                currentHashCode += theEqualContrib.hashCode();
            }
        }
