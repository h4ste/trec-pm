...
public class PubDate implements Serializable
{
    ...
    public boolean equals(java.lang.Object object) {
        ...
        final PubDate that = ((PubDate) object);
        {
            String leftMedlineDate;
            leftMedlineDate = this.getMedlineDate();
            String rightMedlineDate;
            rightMedlineDate = that.getMedlineDate();
            if (this.medlineDate!= null) {
                if (that.medlineDate!= null) {
                    if (!leftMedlineDate.equals(rightMedlineDate)) {
                        return false;
                    }
                } else {
                    return false;
    ...
    public int hashCode() {
        int currentHashCode = 1;
        {
            ...
            String theMedlineDate;
            theMedlineDate = this.getMedlineDate();
            if (this.medlineDate!= null) {
                currentHashCode += theMedlineDate.hashCode();
            }
        }
        {
            currentHashCode = (currentHashCode* 31);
